...
f = ne_dialg(f, 'add', 1, 0, 'pdpopsdacsbdac', 'DAC' );
f = ne_dialg(f, 'add', 1, 0, 'pdpopsdacsbais', 'AI Stat' );
f = ne_dialg(f, 'add', 1, 0, 'pdpopsdacsbv', 'V' );
...
f = ne_dialg(f, 'add', 1, 0, 'pdpopsdacsbhpst', 'HPS T' );
f = ne_dialg(f, 'add', 1, 0, 'pdpopsdacsbhpsp', 'HPS P' );
f = ne_dialg(f, 'add', 1, 0, 'pdpopsdacsbhps_dp', 'HPS dP' );
