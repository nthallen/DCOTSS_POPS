...
dfs.start_col;
dfs.plot('a', 'label', 'Algo', 'plots', {'asws','ag','af','amf','alp','aip','asa','asp'});
...
dfs.plot('asp','label','Sim P','vars',{'Sim_P'});
dfs.plot('m', 'label', 'Moudi', 'plots', {'mm','mc','mstatus'});
dfs.plot('mm','label','Mode','vars',{'MoudiMode'});
...
dfs.plot('hsv','label','Sim Vel','vars',{'Sim_Vel'});
dfs.end_col;
dfs.start_col;
